...
# Balance classes by reducing standard trials
np.random.seed(42)  # For reproducibility
num_oddball = len(combined_oddball)
selected_standard_indices = np.random.choice(len(combined_standard), num_oddball, replace=False)
combined_standard = combined_standard[selected_standard_indices]

print(f"\nBalanced dataset:")
print(f"Standard trials: {len(combined_standard)}")
print(f"Oddball trials: {len(combined_oddball)}")

# -----------------------------------
# 2. Prepare Balanced Data for PyTorch
# -----------------------------------
...
# -----------------------------------
# 3. Define LMDA Model (Same as Before)
# -----------------------------------
...
# -----------------------------------
# 4. Update Weighted BCE Loss for Balanced Data
# -----------------------------------
class WeightedBCELoss(nn.Module):
    def __init__(self, pos_weight=1.0):  # Now 1.0 since classes are balanced
        super().__init__()
...
# -----------------------------------
# 5. K-Fold Cross-Validation Training (Updated for Balanced Data)
# -----------------------------------
from sklearn.model_selection import StratifiedKFold
...
# Since classes are balanced, pos_weight = 1.0
