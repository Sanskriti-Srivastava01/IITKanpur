...
# -----------------------------------
# 1b. Oversample Minority Class (Oddball)
# -----------------------------------
...
if num_oddball < num_standard:
    # Randomly duplicate oddball trials
    indices = np.random.choice(num_oddball, num_standard, replace=True)
    oversampled_oddball = combined_oddball[indices]
    print(f"Oddball class oversampled from {num_oddball} to {len(oversampled_oddball)}")
else:
    oversampled_oddball = combined_oddball

X = np.concatenate([combined_standard, oversampled_oddball], axis=0)
y = np.concatenate([np.zeros(num_standard), np.ones(len(oversampled_oddball))], axis=0)
...
# -----------------------------------
# 4. Use Standard BCE Loss (since classes are balanced)
# -----------------------------------
