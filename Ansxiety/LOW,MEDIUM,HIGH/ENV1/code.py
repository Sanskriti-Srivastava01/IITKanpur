...
def main():
    # ... [all your previous code for data loading and model training] ...
    stage_to_idx = {'Low(25-39)':0, 'Medium(40-49)':1, 'High(50-74)':2}
    labels = list(stage_to_idx.keys())
    
    # EEGNet
    print("EEGNet Results:")
    print(classification_report(eegnet_labels, eegnet_preds, target_names=labels))
    ...
    # LMDA
    print("LMDA Results:")
    print(classification_report(lmda_labels, lmda_preds, target_names=labels))
    ...
    # GCN
    print("GCN Results:")
    print(classification_report(gcn_labels, gcn_preds, target_names=labels))
