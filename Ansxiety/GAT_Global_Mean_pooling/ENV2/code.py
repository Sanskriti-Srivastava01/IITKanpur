...
# 5. GCN + SAGPool Model
class EEGGCN_SAGPoolNet(nn.Module):
    def __init__(self, node_feat_dim, hidden_dim=32, pool_ratio=0.5, num_classes=2):
        super().__init__()
...
model = EEGGCN_SAGPoolNet(node_feat_dim=epoch_size).to(device)
